...
export const CAP_DEFS = [
    ...
    { rarity: 3, series: 'raptor_strike', color: 0xaaaacc, name: 'Silver Raptor', mass: 1.0, bounce: 0.3,                       texFront: 'assets/caps/raptor_strike/11_silver.png',        texBack: 'assets/caps/raptor_strike/12_silver_b.png' },
    { rarity: 3, series: 'raptor_strike', color: 0x22aa77, name: 'Mecha',         mass: 1.0, bounce: 0.3, effect: 'rally',      texFront: 'assets/caps/raptor_strike/12_mecha.png',         texBack: 'assets/caps/raptor_strike/18_mecha_b.png'  },
    ...
    { rarity: 1, series: 'cosmic_caps', color: 0x1199cc, name: "Surfin' Alien",    mass: 1.0, bounce: 0.3,                      texFront: 'assets/caps/cosmic_caps/09_surfin_with_alien.png',    texBack: 'assets/caps/cosmic_caps/cosmic_caps_b.png' },
    { rarity: 2, series: 'cosmic_caps', color: 0x33cc55, name: 'Ollien',           mass: 1.0, bounce: 0.3, effect: 'rally',    texFront: 'assets/caps/cosmic_caps/02_Ollien.png',                texBack: 'assets/caps/cosmic_caps/cosmic_caps_b.png' },
    ...
    { rarity: 2, series: 'cosmic_caps', color: 0x9933cc, name: 'Xeno Kino',        mass: 1.0, bounce: 0.3, effect: 'solo',      texFront: 'assets/caps/cosmic_caps/08_xeno_kino.png',            texBack: 'assets/caps/cosmic_caps/cosmic_caps_b.png' },
    ...
    { rarity: 2, series: 'pewl_ballz', color: 0xbb2211, name: 'Red Stripe',    mass: 1.0, bounce: 0.35,                       texFront: 'assets/caps/pewl_ballz/11_pewls.png', texBack: 'assets/caps/pewl_ballz/11_pewls_b.png' },
